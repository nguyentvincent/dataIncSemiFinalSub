...
#trip.fare.raw = read.big.matrix("trip_fare_3.csv")


trip.fare.raw = read.csv("trip_fare_3.csv",nrows = 100000)
trip.data.raw = read.csv("trip_data_3.csv", nrows = 100000)
...
# {
#   allMarchFares = subset(trip.fare.raw, medallion == medallion.list[i])
#   marchFares[i] = sum(allMarchFares$total_amount) 
# }
# 
# print(paste("The average revenue for drivers in march is", mean(marchFares)))
# 
